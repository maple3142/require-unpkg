			...
			while (1) {
				switch (_context.prev = _context.next) {
					case 0:
						...
						_context.next = 5;
						return _axios2.default.get('https://unpkg.com/' + pkg);
...
var _require2 = function () {
	var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(pkg) {
		var pms;
			...
			while (1) {
				switch (_context2.prev = _context2.next) {
					case 0:
						...
						return _context2.abrupt('return', _require(pkg));

					case 4:
						pms = pkg.map(function (p) {
							return _require(p);
						});
						_context2.next = 7;
						return _promise2.default.all(pms);
...
exports.default = _require2;

if (typeof window !== 'undefined') {
	window.require = _require2;
}
